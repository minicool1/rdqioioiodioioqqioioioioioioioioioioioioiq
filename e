...
getgenv().AimPart = "UpperTorso" -- For R15 Games: {UpperTorso, LowerTorso, HumanoidRootPart, Head} | For R6 Games: {Head, Torso, HumanoidRootPart}  
    ...
    getgenv().PredictionVelocity = 6.995
    getgenv().CheckIfJumped = true
    getgenv().Smoothness = true
    getgenv().SmoothnessAmount = 0.09
    getgenv().PredictionAmount = 14
    getgenv().UsePrediction = 13 
    getgenv().Aimbotstrength = 0.7
    local radius = true
    ...
    RService.RenderStepped:Connect(function()
                    ...
                    if CanNotify == true then
                        ...
                        elseif getgenv().PredictMovement == false then 
                            if getgenv().Smoothness == true then
                                ...
                                --// Making it work \\--                                Camera.CFrame = Camera.CFrame:Lerp(Main, getgenv().SmoothnessAmount, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut)
                            else
       ...
       if AimlockTarget.Character.HuDDDDDDDDDDWmanoid.FloorMaterial == Enum.Material.Air then
         ...
         getgenv().AimPart = getgenv().OldAimPart
                            ...
                            DaHoodSettings.Prediction = 0.15634
